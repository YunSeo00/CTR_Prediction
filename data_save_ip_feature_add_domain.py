...
train_data['site_domain_A_class'] = train_data['site_domain'].apply(hex_to_A_class)
train_data['app_domain_A_class'] = train_data['app_domain'].apply(hex_to_A_class)
...
test_data['site_domain_A_class'] = test_data['site_domain'].apply(hex_to_A_class)
test_data['app_domain_A_class'] = test_data['app_domain'].apply(hex_to_A_class)
...
cat_val = ['hour', 'banner_pos', 'site_category', 'app_category', 'device_type', 'device_conn_type', 'f_1', 'f_3', 'f_4', 'f_6', 'f_8', 
           'site_id_A_class', 'app_ip_A_class', 'site_domain_A_class', 'app_domain_A_class']
...
## Save numpy vector
np.save("./data/ip_feature_add_domain/X_train.npy", X_train)
np.save("./data/ip_feature_add_domain/y_train.npy", y_train)
np.save("./data/ip_feature_add_domain/X_val.npy", X_val)
np.save("./data/ip_feature_add_domain/y_val.npy", y_val)
np.save("./data/ip_feature_add_domain/X_test.npy", X_test)

## save offset, total_field_dims
np.save("./data/ip_feature_add_domain/offsets.npy", offsets.cpu().numpy())
np.save("./data/ip_feature_add_domain/total_field_dims.npy", total_field_dims)
np.save("./data/ip_feature_add_domain/field_dims.npy", field_dims)
